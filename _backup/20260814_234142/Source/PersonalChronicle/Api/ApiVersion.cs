namespace PersonalChronicle.Api
{
    ...
    public sealed class ApiVersion
    {
        ...
        /// DamageDealtTotal, melee/ranged combat-style ratio). Adds a developer-mode
        /// test button (DevTestButtons) that injects sample kill/battle/craft/social
        /// records through the real capture pipeline for UI rendering checks.
