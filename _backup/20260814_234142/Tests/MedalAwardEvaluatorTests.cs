...
namespace PersonalChronicle.Tests
{
    ...
    public class MedalAwardEvaluatorTests
    {
        ...
        {
            Assert.AreEqual("Medal.Labor.Model",
                MedalDef.SeriesKeyOf("Medal.Labor.Model.Gold"));
            Assert.AreEqual("Medal.Labor.Model",
                MedalDef.SeriesKeyOf("Medal.Labor.Model.Silver"));
            Assert.AreEqual("Medal.Labor.Model",
                MedalDef.SeriesKeyOf("Medal.Labor.Model.Bronze"));
        }

        [Test]
        public void SeriesKeyOf_MultiPartDefName_KeepsPrefix()
        {
            Assert.AreEqual("Medal.Kills.Total",
                MedalDef.SeriesKeyOf("Medal.Kills.Total.Gold"));
        }
